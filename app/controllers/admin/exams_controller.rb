class Admin::ExamsController < AdminController
  ...
  def update
    ...
    respond_to do |format|
      if @exam.update_attributes(params[:exam])
        format.html { redirect_to admin_exams_url, notice: 'Exam was successfully updated.' }
  ...
  def create
    ...
    respond_to do |format|
      if @exam.save
        format.html { redirect_to admin_exams_url, notice: 'Exam was successfully created.' }
