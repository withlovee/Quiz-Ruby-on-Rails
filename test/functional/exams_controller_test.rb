...
class ExamsControllerTest < ActionController::TestCase
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post :create, exam: { description: @exam.description, finish_text: @exam.finish_text, name: @exam.name, order: @exam.order, slug: @exam.slug, time: @exam.time }
    end
  ...
  test "should update exam" do
    put :update, id: @exam, exam: { description: @exam.description, finish_text: @exam.finish_text, name: @exam.name, order: @exam.order, slug: @exam.slug, time: @exam.time }
    assert_redirected_to exam_path(assigns(:exam))
  end
